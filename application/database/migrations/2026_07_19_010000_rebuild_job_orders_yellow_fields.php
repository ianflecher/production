...
{
    /**
     * Rebuild job_orders to hold exactly the "yellow" fields the sales agent
     * fills on the printed job order sheet. The table is new (created earlier
     * in this same batch) so dropping and recreating it is safe.
     */
