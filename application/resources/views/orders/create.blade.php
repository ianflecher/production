...
<form method="POST" action="{{ route('orders.store') }}" class="form-steps" onsubmit="return confirmRush(this);">
    ...
    <div class="card panel" style="margin-bottom: 1.4rem;">
        ...
        <label style="display:flex; align-items:flex-start; gap:0.5rem; font-weight:500; margin-top:0.8rem; max-width:620px;">
            <input type="checkbox" id="downpayment_waived" name="downpayment_waived" value="1" style="width:auto; margin:0.2rem 0 0;" @checked(old('downpayment_waived'))>
        ...
        <div class="field" style="max-width:620px; margin-top:0.55rem;">
            ...
            <input id="downpayment_waiver_note" type="text" name="downpayment_waiver_note" maxlength="500" value="{{ old('downpayment_waiver_note') }}" placeholder="e.g. sponsored client / no deposit agreed">
        </div>
        ...
        <div id="withholdingOptions" style="display:none; margin:0.6rem 0 0 1.75rem;">
            ...
            <label style="display:inline-flex; align-items:center; gap:0.35rem; margin:0.35rem 0.7rem 0 0; font-weight:400;"><input type="radio" name="withholding_rate" value="0" @checked((int) old('withholding_rate', 0) === 0) onchange="updatePrice()"> None</label>
            <label style="display:inline-flex; align-items:center; gap:0.35rem; margin:0.35rem 0.7rem 0 0; font-weight:400;"><input type="radio" name="withholding_rate" value="1" @checked((int) old('withholding_rate') === 1) onchange="updatePrice()"> 1%</label>
            <label style="display:inline-flex; align-items:center; gap:0.35rem; margin:0.35rem 0; font-weight:400;"><input type="radio" name="withholding_rate" value="2" @checked((int) old('withholding_rate') === 2) onchange="updatePrice()"> 2%</label>
        </div>
        </div>{{-- /#afterProduct --}}
    </div>
    ...
    <div class="card panel" style="margin-bottom: 1.4rem;">
        ...
        <div class="field" style="max-width: 340px;">
            ...
            <input id="due_date" type="date" name="due_date" required value="{{ old('due_date') }}" onchange="checkCapacity(); onDueDatePicked();">
